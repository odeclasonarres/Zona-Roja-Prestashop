...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			&copy; 2014 {l s='[1]Ecommerce software by %s[/1]' mod='blockcms' sprintf=['PrestaShop™'] tags=['<a class="_blank" href="http://www.prestashop.com">']} &amp; designed by  <a href="http://www.devilthemes.com">devilthemes.com</a>
		</div>
	</section>
	{/if}
	<!-- /MODULE Block footer -->
